...
title: |
  | Cálculo de DEGs
  | Datos bulk RNA-seq: GSE22155-GPL6947
subtitle: " "
...
Las muestras consisten en 22 muestras analizadas con la plataformas GPL6947.
...
GSE22155_GPL6947 <- readr::read_csv("quantiseqr_GSE22155_GPL6947.csv")
rownames(GSE22155_GPL6947) <- GSE22155_GPL6947$Sample

design <- as.data.frame(apply(GSE22155_GPL6947[,2:12],2,as.numeric)) # Primero, las fracciones celulares
design$Samples <- GSE22155_GPL6947$Sample
# Género de los pacientes (1= hombre, 0= mujer)
design$sex_male <- ifelse(GSE22155_GPL6947$`sex:ch1` == "Male", 1, 0)
...
fit <- lmFit(bulk.eset_GPL6947, as.matrix(design)) # el modelo lineal
...
ggplot(bcell, aes(logFC, -log10(P.Value), color = signif)) +
  ...
  ggtitle("GSE22155 dataset, GPL6947 platform \nB cells")
```
...
saveWorkbook(wb, "Linear_model_results_GSE22155_GPL6947_stats.xlsx", overwrite = TRUE)
saveWorkbook(gopbs, "Linear_model_results_GSE22155_GPL6947_GOBPs.xlsx", overwrite = TRUE)
```
