...
# Enrichment analysis
top_2000 <- topTable(fit, coef="B.cells", length(fit$coefficients))
library(gprofiler2)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Macrophages.M1", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
# Para guardar todos los resultados en un Excel
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Macrophages.M2", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Monocytes", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Neutrophils", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
print("No GO-BPs from this list of DEGs")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="NK.cells", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="T.cells.CD4", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="T.cells.CD8", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Tregs", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
```{r, fig.width=10,cache = TRUE, echo = FALSE}
# Enrichment analysis
top_2000 <- topTable(fit, coef="Dendritic.cells", length(fit$coefficients))
gostres <- gost(query = rownames(top_2000)[(top_2000$P.Value <= 0.01 & top_2000$logFC >= 2.5) | top_2000$P.Value <= 0.01 & top_2000$logFC <= -2.5], organism = "hsapiens")
#head(gostres$result)
...
saveWorkbook(wb, "Linear_model_results_GSE61992_stats.xlsx", overwrite = TRUE)
saveWorkbook(gopbs, "Linear_model_results_GSE61992_GOBPs.xlsx", overwrite = TRUE)
```
