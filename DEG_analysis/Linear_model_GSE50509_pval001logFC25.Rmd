...
GSE50509 <- GSE50509[GSE50509$`treatment:ch1` == "none",]
...
# Convertir los datos de expresión del bulk RNA-seq a objeto ExpressionSet:
bulk.eset <- Biobase::ExpressionSet(assayData = as.matrix(as.data.frame(bulk.mtx)[,colnames(bulk.mtx) %in% GSE50509$Sample[GSE50509$`treatment:ch1` == "none"]]))
print("ExpressionSet object:")
bulk.eset
...
saveWorkbook(wb, "Linear_model_results_GSE50509_stats.xlsx", overwrite = TRUE)
saveWorkbook(gopbs, "Linear_model_results_GSE50509_GOBPs.xlsx", overwrite = TRUE)
```
