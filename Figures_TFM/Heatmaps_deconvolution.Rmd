...
df_GSE61992$treatment <- GSE61992$Description_2 # Harmonización de la definición del tratamiento
...
df_GSE91061$treatment <- ifelse(GSE91061$`visit (pre or on treatment):ch1` == "Pre", 1,2)# Columna de momento de toma de la biopsia
...
df_GSE91061$response <- ifelse(GSE91061$`response:ch1` == "PD", 1, 
...
annotation_col = as.data.frame(cbind(Treatment =as.factor(metadata$treatment),
...
annotation_col = as.data.frame(cbind(Treatment =(metadata$loc_melan),
                                     Sample_type = as.factor(metadata$sample_type),
#                                     Response = as.factor(metadata$response), 
                               samples =metadata$samples))
rownames(annotation_col) = metadata$samples
