...
Las muestras consisten en 61 muestras analizadas con la plataformas GPL10558, y con varios tratamientos: dabrafenib + trametinib.
...
ref.based.estimates <- inner_join(bulk_metadata, ref.based.estimates, by = "geo_accession")
knitr::kable(head(ref.based.estimates[,1:7]), digits=2, caption = "Sección de las primeras muestras como ejemplo del resultado")
write.csv(ref.based.estimates,"./bisque_GSE61992.csv", row.names = FALSE)
```
