...
```{r, cache = TRUE}
res <- BisqueRNA::ReferenceBasedDecomposition(bulk.eset, sc.eset, markers=NULL, 
                                              use.overlap=FALSE)
```
...
knitr::kable(head(ref.based.estimates[,1:7]), digits=2, 
             caption = "Sección de las primeras muestras como ejemplo del resultado")
write.csv(ref.based.estimates,"./bisque_GSE54467.csv", row.names = FALSE)
```
