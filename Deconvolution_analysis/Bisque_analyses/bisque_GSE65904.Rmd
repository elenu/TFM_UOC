...
En este análisis utilizo los datos del estudio GSE65904 descargados mediante la función ```getGEO``` des de la base de datos GEO, del NCBI: <https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE65904>. 
...
write.csv(ref.based.estimates,"./bisque_GSE65904.csv", row.names = FALSE)
```
