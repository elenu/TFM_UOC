...
extra_to_load <- c("knitr","stringr", "stringi", "ggrepel","ggpubr", "ggbreak","reshape2","ggfortify","cowplot","GEOquery","Seurat","data.table","limma","biomaRt")
...
En este análisis utilizo los datos del estudio TCGA-SKCM descargados de la página oficial del portal GDC, de NIH (<https://portal.gdc.cancer.gov/projects/TCGA-SKCM>). 

Las muestras consisten en 214 muestras tumorales metastáticas. Este estudio es de especial interés para el TFM debido a que los autores también proporcionan metadata la supervivencia de los pacientes, cosa que permitirá estudiar posibles correlaciones con las poblaciones obtenidas de la deconvolución.
...
sc_gex <-GSE72056_melanoma_single_cell_revised_v2[GSE72056_melanoma_single_cell_revised_v2$Cell %in% rownames(gex2),] # Selecciono los genes que también tengo en el bulk RNA-seq para simplificar y acelerar el análisis
...
write.csv(ref.based.estimates,"./bisque_tcga_skcm.csv", row.names = FALSE)
```
