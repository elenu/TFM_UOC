...
Las muestras consisten en 61 muestras analizadas con la plataformas GPL10558, y con varios tratamientos: dabrafenib, vemurafenib, o ninguno.
...
write.csv(ref.based.estimates,"./bisque_GSE50509.csv", row.names = FALSE)
```
