---
title: |
  | Deconvolución de datos de melanoma con BayesPrism:
...
Repositorio GitHub de : <https://github.com/Danko-Lab/BayesPrism/blob/main/tutorial_deconvolution.pdf>

```{r, cache = TRUE, warning=FALSE, message=FALSE}
knitr::opts_chunk$set(warning=FALSE)
package_to_load <- c("readr", "dplyr", "ggplot2", "tidyr", "dplyr","RColorBrewer", 
                     "Biobase","BayesPrism", "gplots")
...
```{r, cache = TRUE, warning=FALSE, message=FALSE}
plot.cor.phi (input=sc.eset,
              input.labels=rownames(sc_gex3),
...
myPrism <- new.prism(
  ...
  cell.type.labels = rownames(sc_gex3),
  cell.state.labels = rownames(sc_gex3),
  key="tumor",
  outlier.cut=0.01,
