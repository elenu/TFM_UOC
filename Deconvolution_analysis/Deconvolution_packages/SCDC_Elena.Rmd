---
title: |
  | Deconvolución de datos de mealoma con SCDC:
...
Primero creamos el objeto de SCDC para trabajar.

```{r}
bulkseger.scseger <- SCDC_prop(bulk.eset = bulk.eset, sc.eset = sc.eset, ct.varname = "cellType", 
                               sample = "SubjectName", ct.sub = c(unique(sc.eset$cellType))#, 
